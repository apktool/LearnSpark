...
object GroupingAndAggregation {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // create a sequence of case class objects (we defined the case class above)
    val custs = Seq(
    ...
    // basic form of aggregation assigns a function to each non-grouped
    // column -- you map each column you want aggregated to the name of
    // the aggregation function you want to use automatically includes
    // grouping columns in the DataFrame
    ...
    // there are some special short cuts on GroupedData to aggregate all numeric columns
